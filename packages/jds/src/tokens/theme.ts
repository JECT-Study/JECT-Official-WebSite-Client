...
export const theme = {
  ...
  "color": {
    "semantic": {
      ...
      "curtain": {
        "static": {
          "bright": "var(--semantic-curtain-static-bright)",
          "dim": "var(--semantic-curtain-static-dim)",
          "dimmer": "var(--semantic-curtain-static-dimmer)"
        },
        "standard": "var(--semantic-curtain-standard)"
      },
      "feedback": {
        "positive": {
          "alpha": {
  ...
  "scheme": {
    "semantic": {
      ...
      "margin": {
        ...
        "4xl": "var(--semantic-margin-4xl)",
        "5xl": "var(--semantic-margin-5xl)",
        "6xl": "var(--semantic-margin-6xl)"
      },
      "position": {
