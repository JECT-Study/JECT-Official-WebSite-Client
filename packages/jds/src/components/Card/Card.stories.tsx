...
export const CompoundBasic: Story = {
  ...
  render: args => (
    <div>
      <Card.Root {...args}>
        <Card.Thumbnail image={{ alt: "프로젝트 이미지" }} />
        <Card.Content>
  ...
  render: () => (
    <div style={{ width: "400px" }}>
      <Card.Root layout='vertical' variant='plate'>
        <Card.Thumbnail image={{ alt: "커스텀 카드" }} />
        <Card.Content>
  ...
  render: () => (
    <div style={{ width: "400px" }}>
      <Card.Root layout='vertical' variant='post'>
        <Card.Thumbnail image={{ alt: "블로그 포스트 사진" }} />
        <Card.Content>
    ...
    <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
      <div style={{ width: "350px" }}>
        <Card.Root layout='vertical' variant='plate' interactive>
          <Card.Thumbnail image={{ alt: "클릭 가능한 카드" }} />
          <Card.Content>
      ...
      <div style={{ width: "350px" }}>
        <Card.Root layout='vertical' variant='plate' interactive>
          <Card.Thumbnail image={{ alt: "버튼 카드" }} />
          <Card.Content>
      ...
      <div style={{ width: "480px", height: "240px" }}>
        <Card.Root layout='horizontal' variant='plate' interactive>
          <Card.Thumbnail image={{ alt: "가로 레이아웃" }} />
          <Card.Content>
  ...
  render: () => (
    <div style={{ display: "flex", gap: "24px", flexDirection: "column" }}>
      <div>
        ...
        <div style={{ width: "350px" }}>
          <Card.Root layout='vertical' variant='plate' interactive>
            <Card.Thumbnail image={{ alt: "인터랙티브 카드" }} />
            <Card.Content>
      ...
      <div>
        ...
        <div style={{ width: "350px" }}>
          <Card.Root layout='vertical' variant='plate'>
            <Card.Thumbnail image={{ alt: "일반 카드" }} />
            <Card.Content>
