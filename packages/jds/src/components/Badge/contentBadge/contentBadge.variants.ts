...
export const contentBadgeThemeMutedStylesMap = (theme: Theme): ContentBadgeThemeStyle => ({
  solid: {
    red: {
      bg: theme.color.theme.red.alpha.subtler,
      color: theme.color.theme.red.alpha.subtle,
      border: 'none',
    },
    orange: {
      bg: theme.color.theme.orange.alpha.subtler,
      color: theme.color.theme.orange.alpha.subtle,
      border: 'none',
    },
    amber: {
      bg: theme.color.theme.amber.alpha.subtler,
      color: theme.color.theme.amber.alpha.subtle,
      border: 'none',
    },
    yellow: {
      bg: theme.color.theme.yellow.alpha.subtler,
      color: theme.color.theme.yellow.alpha.subtle,
      border: 'none',
    },
    lime: {
      bg: theme.color.theme.lime.alpha.subtler,
      color: theme.color.theme.lime.alpha.subtle,
      border: 'none',
    },
    green: {
      bg: theme.color.theme.green.alpha.subtler,
      color: theme.color.theme.green.alpha.subtle,
      border: 'none',
    },
    emerald: {
      bg: theme.color.theme.emerald.alpha.subtler,
      color: theme.color.theme.emerald.alpha.subtle,
      border: 'none',
    },
    teal: {
      bg: theme.color.theme.teal.alpha.subtler,
      color: theme.color.theme.teal.alpha.subtle,
      border: 'none',
    },
    cyan: {
      bg: theme.color.theme.cyan.alpha.subtler,
      color: theme.color.theme.cyan.alpha.subtle,
      border: 'none',
    },
    sky: {
      bg: theme.color.theme.sky.alpha.subtler,
      color: theme.color.theme.sky.alpha.subtle,
      border: 'none',
    },
    blue: {
      bg: theme.color.theme.blue.alpha.subtler,
      color: theme.color.theme.blue.alpha.subtle,
      border: 'none',
    },
    violet: {
      bg: theme.color.theme.violet.alpha.subtler,
      color: theme.color.theme.violet.alpha.subtle,
      border: 'none',
    },
    purple: {
      bg: theme.color.theme.purple.alpha.subtler,
      color: theme.color.theme.purple.alpha.subtle,
      border: 'none',
    },
    fuchsia: {
      bg: theme.color.theme.fuchsia.alpha.subtler,
      color: theme.color.theme.fuchsia.alpha.subtle,
      border: 'none',
    },
    pink: {
      bg: theme.color.theme.pink.alpha.subtler,
      color: theme.color.theme.pink.alpha.subtle,
      border: 'none',
    },
    rose: {
      bg: theme.color.theme.rose.alpha.subtler,
      color: theme.color.theme.rose.alpha.subtle,
      border: 'none',
    },
  },
  alpha: {
  ...
  outlined: {
    red: {
      bg: 'none',
      color: theme.color.theme.red.alpha.assistive,
      border: theme.color.theme.red.alpha.subtler,
    },
    orange: {
      bg: 'none',
      color: theme.color.theme.orange.alpha.assistive,
      border: theme.color.theme.orange.alpha.subtler,
    },
    amber: {
      bg: 'none',
      color: theme.color.theme.amber.alpha.assistive,
      border: theme.color.theme.amber.alpha.subtler,
    },
    yellow: {
      bg: 'none',
      color: theme.color.theme.yellow.alpha.assistive,
      border: theme.color.theme.yellow.alpha.subtler,
    },
    lime: {
      bg: 'none',
      color: theme.color.theme.lime.alpha.assistive,
      border: theme.color.theme.lime.alpha.subtler,
    },
    green: {
      bg: 'none',
      color: theme.color.theme.green.alpha.assistive,
      border: theme.color.theme.green.alpha.subtler,
    },
    emerald: {
      bg: 'none',
      color: theme.color.theme.emerald.alpha.assistive,
      border: theme.color.theme.emerald.alpha.subtler,
    },
    teal: {
      bg: 'none',
      color: theme.color.theme.teal.alpha.assistive,
      border: theme.color.theme.teal.alpha.subtler,
    },
    cyan: {
      bg: 'none',
      color: theme.color.theme.cyan.alpha.assistive,
      border: theme.color.theme.cyan.alpha.subtler,
    },
    sky: {
      bg: 'none',
      color: theme.color.theme.sky.alpha.assistive,
      border: theme.color.theme.sky.alpha.subtler,
    },
    blue: {
      bg: 'none',
      color: theme.color.theme.blue.alpha.assistive,
      border: theme.color.theme.blue.alpha.subtler,
    },
    violet: {
      bg: 'none',
      color: theme.color.theme.violet.alpha.assistive,
      border: theme.color.theme.violet.alpha.subtler,
    },
    purple: {
      bg: 'none',
      color: theme.color.theme.purple.alpha.assistive,
      border: theme.color.theme.purple.alpha.subtler,
    },
    fuchsia: {
      bg: 'none',
      color: theme.color.theme.fuchsia.alpha.assistive,
      border: theme.color.theme.fuchsia.alpha.subtler,
    },
    pink: {
      bg: 'none',
      color: theme.color.theme.pink.alpha.assistive,
      border: theme.color.theme.pink.alpha.subtler,
    },
    rose: {
      bg: 'none',
      color: theme.color.theme.rose.alpha.assistive,
      border: theme.color.theme.rose.alpha.subtler,
    },
  },
});
