...
export const JOB_FAMILY_RECRUITMENT_INFO: Record<JobFamily, JobFamilyRecruitmentInfo> = {
  ...
  APP: {
    roleDescription: {
      title: "앱 개발자는 모바일 환경에서 사용자와 직접 맞닿는 서비스를 구현합니다:",
      items: [
        "사용자가 모바일 환경에서 서비스를 자연스럽게 이용할 수 있도록 앱 화면과 기능을 구현합니다.",
        "PM, PD, BE와 긴밀히 협업하며 기획, 디자인, 서버 데이터를 앱 흐름에 맞게 연결합니다.",
    ...
    experiences: {
      title: "이런 경험들을 할 수 있어요:",
      items: [
        "모바일 서비스의 요구사항 분석부터 화면 구현, API 연동, 테스트까지 앱 개발 전 과정을 경험할 수 있습니다.",
        "AOS, iOS, 크로스 플랫폼 등 본인이 사용하는 기술 스택을 기반으로 실제 서비스 수준의 앱 기능을 직접 구현합니다.",
        "서버 API와 데이터를 연동하며 앱 내 데이터 흐름, 상태 관리, 예외 처리 구조를 설계하는 경험을 얻습니다.",
        "모바일 환경의 특성을 고려해 화면 전환, 터치 인터랙션, 반응 속도, 앱 사용성을 개선하는 감각을 쌓을 수 있습니다.",
        "PM, PD, BE와 협업하는 과정에서 기획 의도와 디자인, 기술적 제약을 함께 조율하며 문제 해결 능력을 키울 수 있습니다.",
        "빌드, 테스트, 배포 준비 과정을 경험하며 실제 운영 가능한 앱 서비스를 만드는 흐름을 이해할 수 있습니다.",
      ],
    },
    qualifications: {
      title: "이런 분과 함께 하고 싶어요:",
      items: [
        "Android, iOS, Flutter, React Native 등 앱 개발 기술 중 하나 이상에 대한 이해가 있는 분",
        "실제 서비스의 모바일 화면 구현과 API 연동에 도전해보고 싶은 분",
        "사용자 경험을 고려해 앱의 흐름과 인터랙션을 고민할 수 있는 분",
        "PM, PD, BE와 원활하게 소통하며 더 나은 모바일 서비스 구조를 함께 만들어갈 수 있는 분",
        "플랫폼별 제약과 앱 안정성을 고려하며 문제를 해결하려는 태도를 가진 분",
        "주도적으로 학습하고, 코드 품질과 서비스 완성도를 함께 고민하며 성장하고 싶은 분",
        "약 3개월 동안 적극적으로 시간을 투자하고 끝까지 책임감 있게 활동할 수 있는 분",
      ],
    },
  },
