...
import CreateNewTab from "@/components/common/CreateNewTab";
...
export const applyProcedureList: Procedure[] = [
    {   
        ...
        content: (
            <p>
            젝트 웹사이트의&nbsp;
            <button onClick={moveToBottom} className='cursor-pointer text-feedback-information-dark decoration-feedback-information-dark underline'>
              지원하기
            </button>
            를 통해 접수를 받고 있어요.
          </p>
