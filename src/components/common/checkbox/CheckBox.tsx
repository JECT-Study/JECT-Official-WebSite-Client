    ...
    <div className={clsx('gap-2xs inline-flex items-center', className)}>
      <div
        className={clsx(
          ...
          'has-focus-visible:shadow-focus-visible active:shadow-focus-visible duration-faster relative ease-(--motion-fluent) outline-none after:pointer-events-none after:absolute after:inset-0 after:rounded-[inherit] hover:after:bg-[rgba(26,27,35,0.12)] active:after:bg-[rgba(26,27,35,0.12)]',
        )}
      >
