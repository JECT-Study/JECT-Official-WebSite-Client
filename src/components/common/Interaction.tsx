...
function Interaction({ children, variant, density, radius }: InteractionProps) {
  ...
  return (
    <div>
      <div
        className={`hover:${background} focus-visible:${background} active:${background} *:hover:${opacity} *:active:${opacity} ${radius} *:focus-visible:outline-interactive-focus-dark *:focus-visible:hover:opacity-visible inline-block *:focus-visible:outline-4`}
      >
        {children}
      </div>
    </div>
