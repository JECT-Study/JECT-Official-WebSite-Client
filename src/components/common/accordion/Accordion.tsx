...
function Accordion({ title, label, children, caption }: AccordionProps) {
  ...
  return (
    <div className='gap-xs flex flex-col'>
      <button
        onClick={toggle}
        className='interaction-default-subtle transition-faster-fluent gap-xs radius-3xs flex w-full text-start before:scale-x-102 before:scale-y-128 [&>*:first-child]:grow'
      >
